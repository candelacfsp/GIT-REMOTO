...
<body>
	...
	<center>
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			...
			<param name="movie" value="anulacionPedido.swf?mensaje=<%=mensaje%>" />
			<param name="quality" value="high" />
			<embed src="anulacionPedido.swf?mensaje=<%=mensaje%>" quality="high"
	...
	<center>
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
			...
			<param name="quality" value="high" />
			<embed src="anulacionPedido.swf" quality="high"
				type="application/x-shockwave-flash" width="800" height="600"
				pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>
		</object>
	</center>
