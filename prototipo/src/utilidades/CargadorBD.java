...
public class CargadorBD {
	...
	*/
	...
	private void cargarUsuarios(EntityManager em){
		...
		//NOTA: A�ADIR CODIGOS PARA LOS TIPOS DE USUARIOS.
	...
	private void cargarCatalogosTomosProds(EntityManager em){
		...
		prod6.setDescripcion("Esmalte para u�as");
		...
		//NOTA: A�ADIR  que solamente se puedan a�adir los tipos de producto del mismo tipo que contenga el TOMO.
