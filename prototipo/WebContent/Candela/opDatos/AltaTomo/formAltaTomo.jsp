...
<%@page session="true" %>
 ...
 <%
	...
	if(nroTomo!=null && (!nroTomo.equals(""))){ 						 
		...
		int i=0;
		while (i<tomos.size() && tomos.get(i).getCodigoTomo()!=nro_tomo){
			i++;
		}
		
 
		if (i>=tomos.size()){ //Si el tomo no esta en la coleccion de tomos del catalogoVigente de Candela, se obtiene el catalogo nuevo y se añade un nuevo tomo
